      ...
      <Grid container spacing={2} className={classes.grid}>
        <Grid item xs={4}>
          ...
          <Box>
            ...
            <Typography variant="p" component="p">
              Nous offrons les meilleurs tarifs de l'industrie pour les frais de
              service et de transaction par carte de crédit.
            </Typography>
          </Box>
        </Grid>
        <Grid item xs={4}>
        ...
        <Grid item xs={4}>
          ...
          <Box>
            ...
            <Typography variant="p" component="p">
              ...
              en quelques minutes. C'est tellement facile d'utiliser notre
              plateforme.
            </Typography>
          </Box>
        </Grid>
        ...
        <Grid item xs={4}>
          ...
          <Box>
            ...
            <Typography variant="p" component="p">
              Construisez facilement votre site d'événement. Vendre des billets,
              inscrivez vos participants et ramasse des fonds dans un seul
              endroit.
            </Typography>
          </Box>
        </Grid>
        <Grid item xs={4}>
          ...
          <Box>
            ...
            <Typography variant="p" component="p">
              ...
              d'organisateurs à planifier et à organiser leurs événements avec
              notre plateforme.
            </Typography>
          </Box>
        </Grid>
